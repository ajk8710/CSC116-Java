...
public class MyMath {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(average(100.0, 98.8, 77.3)); // EXPECTED OUTPUT: 92.0333333333333
                                                        // (possibly different based on quirks of doubles)
    ...
    public static double min(double a, double b, double c) {
        double minOfAB = Math.min(a, b);
        double minimum = Math.min(minOfAB, c);
        return minimum;
    ...
    public static double max(double a, double b, double c) {
        double maxOfAB = Math.max(a, b);
        double maximum = Math.max(maxOfAB, c);
        return maximum;
    }
